...
function addToCart(id){const items=cartItems();const found=items.find(i=>i.id===id);found?found.qty++:items.push({id,qty:1});saveCart(items);document.getElementById('cartCount').textContent=cartCount();alert('Added to cart');}
